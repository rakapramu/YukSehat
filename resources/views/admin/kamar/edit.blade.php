    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin-kamar.update', $datas->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_kamar"
                                    placeholder="Masukkan Nama Obat" value="{{ $datas->nama_kamar }}" />
                                @error('nama_kamar')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="fasilitas" id="" cols="30">{{ $datas->fasilitas }}</textarea>
                                @error('fasilitas')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
